...
library ConfigSchema {
  ...
  function setIsPaused(uint256 _tableId, bool isPaused) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked(isPaused));
  }

  function setValue2(uint256 _tableId, uint32 value2) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    StoreSwitch.setField(_tableId, _keyTuple, 1, abi.encodePacked(value2));
  }

  function setSomeBlob(uint256 _tableId, bytes memory someBlob) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    StoreSwitch.setField(_tableId, _keyTuple, 2, bytes(someBlob));
  }

  function setSomeNumbers(uint256 _tableId, uint256[] memory someNumbers) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);

    StoreSwitch.setField(_tableId, _keyTuple, 3, EncodeArray.encode(someNumbers));
  }

  function getIsPaused(uint256 _tableId) internal view returns (bool isPaused) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function getValue2(uint256 _tableId) internal view returns (uint32 value2) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function getSomeBlob(uint256 _tableId) internal view returns (bytes memory someBlob) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function getSomeNumbers(uint256 _tableId) internal view returns (uint256[] memory someNumbers) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function set(uint256 _tableId, ConfigData memory _table) internal {
    set(_tableId, _table.isPaused, _table.value2, _table.someBlob, _table.someNumbers);
  }

  /** Get the table's data */
  function get(uint256 _tableId) internal view returns (ConfigData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function get(uint256 _tableId, IStore _store) internal view returns (ConfigData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function decode(bytes memory _blob) internal view returns (ConfigData memory _table) {
